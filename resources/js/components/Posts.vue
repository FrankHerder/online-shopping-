                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div v-if="form.errors.has('name')"
                                                            v-html="form.errors.get('name')" style="color:red;" />
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div v-if="form.errors.has('email')"
                                                            v-html="form.errors.get('email')" style="color:red;" />
                                                    </div>
                                                </div>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable"
                                            ...
                                            <tbody>
                                                <tr class="odd" v-for="profile in profiles" :key="profile.id">
                                                    ...
                                                    <td><button type="button" @click="EditModal(profile)"
